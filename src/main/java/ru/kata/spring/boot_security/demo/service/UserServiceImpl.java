...
public class UserServiceImpl implements UserService {
    ...
    public void addDefaultUser() {
        ...
        User user1 = new User("userName","userSurname",(byte) 30, "user@mail.com", "user","user",roles1);
        User user2 = new User("adminName","adminSurname",(byte) 30, "admin@mail.com", "admin","admin",roles2);
        save(user1);
        save(user2);
        }
}
